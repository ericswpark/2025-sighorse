...
On a separate branch, #link("https://github.com/purduehackers/events/commit/97217e07426cf092e889a7102354bb3fe4e5edc0")[
the first commit that wiped out our NextJS codebase] and 
#link("https://github.com/purduehackers/events/commit/e0bd3b224ade828bb687d22a1abb8f733cae6af5")[set up a clean AstroJS template was created]. This marked the start of the
migration attempt.
...
use REST for their API endpoints. Instead, they have #link("https://www.sanity.io/docs/content-lake/how-queries-work")[a custom query language named GROQ] that I had to learn, just to query all of the
events that were stored in their backend.
...
uploaded with the retrospectives. To facilitate this, #link("https://github.com/purduehackers/events/tree/6e061709cc668f8c67cb586af6ede7211fce7b75/src/content")[several Python scripts were written]
...
subfolder, #link("https://github.com/purduehackers/events/blob/main/src/content.config.ts")[a single Content Collection configuration file]
...
all of the functionality carried over, with #link("https://github.com/purduehackers/events/issues/97")[only a handful of minor bugs]
